...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-vista-move-engine-detail.ps1

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-vista-move-engine-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-vista-move-engine-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-vista_move_engine_stack-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
