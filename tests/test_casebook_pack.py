"""Regression checks for the vista-move-engine-stack casebook."""
...
from casebook.harness import assert_expected, vista_move_engine_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(vista_move_engine_stack_summary(), assert_expected())
